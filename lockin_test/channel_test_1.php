...
require_once dirname(__DIR__ ). '/Channel/src/Server.php';
require_once dirname(__DIR__ ). '/Channel/src/Client.php';
...
$worker->onWorkerStart = function($worker)
{
    ...
    Channel\Client::connect('192.168.17.129', 2206);


    // 以自己的进程id为事件名称
    $event_name = $worker->id;
    // 订阅worker->id事件并注册事件处理函数 $event_data是事件发布(publish)时传递的事件数据
